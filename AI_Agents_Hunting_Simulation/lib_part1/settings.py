...
def init_settings(agentType, cloning=True, worldX=10, worldY=10, gameSteps=100, runs=100, crit="high", huts="high"):
    '''
    ...
    crit_population = "high" #options are: high (60%), medium (30%), low (15%)
    ...
    if crit_population == "high":
        ...
        world_crit = world_x * world_y * 0.3 # default
